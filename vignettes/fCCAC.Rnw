...
\begin{small}
<<fCCACexample, fig=TRUE, include=FALSE, fig.width=1, fig.height=3>>=
options(width=60);
...
\begin{small}
<<heatmapPlot, fig=TRUE, include=FALSE, fig.width=1, fig.height=1.5>>=
options(width=60)
if (.Platform$OS.type == "windows") { print("...rtracklayer is unable to read bigWig format files in Windows...") }
